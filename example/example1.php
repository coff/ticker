...
$ticker->addTick(new CallableTick(Time::SECOND_1000TH, 1, function (): void {
...
$ticker->addTick(new CallableTick(Time::SECOND_100TH, 1, function (): void {
    /* Consider Ticker has some time of sleep set to some safe level to prevent heating up your CPU although this
       can be also set manually by Ticker::setSleep() / Ticker::setUSleep() */
...
$ticker->addTick(new CallableTick(Time::SECOND_10TH, 1, function (): void {
    /* Consider Ticker has some time of sleep set to some safe level to prevent heating up your CPU although this
       can be also set manually by Ticker::setSleep() / Ticker::setUSleep() */
    echo ',';
}));
...
$i = 0;
$ticker->addTick(new CallableTick(Time::SECOND, 1, function () use (&$i): void {
    echo "$i".PHP_EOL;
    ++$i;
}));

$ticker->addTick(new CallableTick(Time::MINUTE, 1, function () use (&$i): void {
    $i = 0;
    echo PHP_EOL;
}));
